...
(library Library_1
	...
	(patternDef "5530122F" (originalName "5530122F")
		(multiLayer
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 1.270, -1.025) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.89 3.69) (pt 3.43 3.69) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.43 3.69) (pt 3.43 -4.44) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.43 -4.44) (pt -0.89 -4.44) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.89 -4.44) (pt -0.89 3.69) (width 0.025))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.89 4.69) (pt 4.43 4.69) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 4.43 4.69) (pt 4.43 -6.74) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 4.43 -6.74) (pt -1.89 -6.74) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.89 -6.74) (pt -1.89 4.69) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.57 -4.44) (pt -0.03 -4.44) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.03 -4.44) (pt -0.03 -4.44) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.27, -4.44) (radius 1.3) (startAngle 180.0) (sweepAngle 180.0) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt -0.89 -1.375) (pt -0.89 -4.375) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -0.89 -4.375) (pt -0.89 -4.44) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -0.89 -4.44) (pt 3.43 -4.44) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 3.43 -4.44) (pt 3.43 -1.375) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -0.89 3.69) (pt 3.43 3.69) (width 0.1))
		)
	)
	(symbolDef "553-0122F" (originalName "553-0122F")
	...
	(compDef "553-0122F" (originalName "553-0122F") (compHeader (numPins 4) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "553-0122F"))
		(attachedPattern (patternNum 1) (patternName "5530122F")
			(numPads 4)
			(padPinMap
		...
		(attr "Mouser Part Number" "645-553-0122F")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Dialight/553-0122F?qs=0KZIkTEbAAuchVNYUHfDmw%3D%3D")
		(attr "Manufacturer_Name" "Dialight")
		(attr "Manufacturer_Part_Number" "553-0122F")
		(attr "Description" "553 Series CBI 3mm 2hx1w G, Cath R")
		(attr "<Hyperlink>" "https://s3-us-west-2.amazonaws.com/catsy.557/C17277.pdf")
		(attr "<Component Height>" "9.65")
		(attr "<STEP Filename>" "553-0122F.stp")
		(attr "<STEP Offsets>" "X=1.15;Y=-4.47;Z=8.96")
